...
const lesson5 = () => {
  ...
  return (
    <div className="overflow-auto">
      ...
      <div>
        <div>
          <div className="flex justify-between w-[200px] items-center px-[14px] py-1.5 border rounded-md text-black ml-[50vw] absolute mt-[2vh]">
            <button className="flex justify-between w-full items-center cursor-pointer">
              Columns
              <svg
                stroke="currentColor"
                fill="currentColor"
          ...
          <div className="absolute ml-[44.5vw] mt-[22vh] z-20 top-14 border border-black shadow-[0px_4px_6px_rgba(0_0_0_0.08)] bg-white w-[306px] ">
